...
public class PremiumPurchaseServiceImpl implements PremiumPurchaseService {
    ...
    @Override
    public ResponseEntity<String> addPremiumPurchase(PremiumPurchaseRequest premiumPurchaseRequest, String username) {
        ...
        return ResponseEntity.ok("Premium purchase created successfully.");
    }
